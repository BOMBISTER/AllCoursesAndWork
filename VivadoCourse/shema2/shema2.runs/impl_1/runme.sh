...
HD_PWD='D:/Tasks/shema2/shema2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shema2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shema2.tcl -notrace
